"""Module to count, time, and calculate detection."""
...
class Flags:
    ...
    def __init__(self):
        ...
        # Attributes to represent the detection event.
...
class Calculator(Timer, Counter):
    ...
    def calc_reg_latency(self):
        """Calculate the latency to exchange data with PLC registers."""
        self.reg_latency = time.time() - self.register_time

    def calc_coil_latency(self):
        """Calculate the latency to exchange data with PLC Coils."""
